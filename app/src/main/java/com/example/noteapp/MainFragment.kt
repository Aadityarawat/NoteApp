...
@AndroidEntryPoint
class MainFragment : Fragment(), NotesAdapter.NoteItemClickListener, PopupMenu.OnMenuItemClickListener {
    ...
    override fun onCreateView(
        ...
        bottomNavigationView = activity?.findViewById(R.id.bottomnavigationbar)
    ...
    private fun onObserve() {
        Cons.userName?.let {
            mainViewModel.getNote(it).observe(viewLifecycleOwner) {
